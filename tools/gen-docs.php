...
/**
 * This file is part of milpa/plugin — the GitHub-native plugin distribution core of the Milpa PHP framework.
 *
...
$config = new Milpa\Docs\SiteConfig(
    brand: 'Milpa Plugin',
    nsPrefix: 'Milpa\\Plugin\\',
    installCommand: 'composer require milpa/plugin',
    repoUrl: 'https://github.com/getmilpa/plugin',
    pagesUrl: 'https://getmilpa.github.io/plugin/',
    heroParagraph: 'The <strong>GitHub-native plugin distribution</strong> core of Milpa — resolves '
        . 'semver-constrained releases straight from GitHub, downloads and validates <code>milpa.json</code> '
        . 'manifests, orders plugins by their declared contracts, and tracks installed state in '
        . '<code>milpa.lock</code>. No registry server and no Packagist-style index: GitHub releases and tags '
